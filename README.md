...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/calm-band-873c)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/calm-band-873c
```

A live public deployment of this template is available at [https://calm-band-873c.templates.workers.dev](https://calm-band-873c.templates.workers.dev)
